...
Space Next Action v0.3 (`internal/thumb-action/`) is another independent extension. Space invokes the existing main action button above the minimap; for units needing orders, a second press uses Civ V's normal Skip mission and advances.
